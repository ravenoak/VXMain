...
from vxweb.controllers.image import ImageController
from vxweb.controllers.page import PageController
...
class RootController(BaseController):
    """
    The root controller for the vxweb application.
    ...
    @expose('vxweb.templates.about')
    def about(self):
        """Handle the 'about' page."""
        return dict(page='about')

    @expose('vxweb.templates.environ')
    def environ(self):
