...
from vxweb.model.project import Project
from vxweb.widgets.forms import create_project_form, update_project_form, update_project_filler
...
class ProjectController(BaseController):
    ...
    @expose('vxweb.templates.project.update')
    ...
    @expose('vxweb.templates.project.read')
    ...
    @expose('vxweb.templates.project.list')
    def list_by_id(self):
