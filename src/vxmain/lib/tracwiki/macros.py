...
from vxmain.lib.tracwiki.api import IWikiMacroProvider, WikiSystem, parse_args
from vxmain.lib.tracwiki.formatter import (
...
class ImageMacro(WikiMacroBase):
    ...
    def expand_macro(self, formatter, name, content):
        ...
        #        ... or directly vxmain.lib.tracwiki.extract_link
        try:
...
class MacroListMacro(WikiMacroBase):
    ...
    def expand_macro(self, formatter, name, content):
        from vxmain.lib.tracwiki.formatter import system_message
