...
from vxmain.lib.tracwiki.api import WikiSystem, parse_args, unquote_label
from vxmain.lib.tracwiki.parser import WikiParser, parse_processor_args
...
class Formatter(object):
    ...
    def _make_interwiki_link(self, ns, target, label):
        from vxmain.lib.tracwiki.interwiki import InterWikiMap        
