...
from trac.web.chrome import (Chrome, INavigationContributor, ITemplateProvider,
                             ...
                             web_context)
from vxmain.lib.tracwiki.api import IWikiPageManipulator, WikiSystem, validate_page_name
from vxmain.lib.tracwiki.formatter import format_to, OneLinerFormatter
from vxmain.lib.tracwiki.model import WikiPage
...
class WikiModule(Component):
    ...
    def get_templates_dirs(self):
        return [pkg_resources.resource_filename('vxmain.lib.tracwiki', 'templates')]
