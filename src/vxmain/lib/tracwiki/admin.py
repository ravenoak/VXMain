...
from vxmain.lib.tracwiki import model
from vxmain.lib.tracwiki.api import WikiSystem, validate_page_name
...
class WikiAdmin(Component):
    ...
    def _do_upgrade(self):
        self.load_pages(pkg_resources.resource_filename('vxmain.lib.tracwiki',
                                                        'default-pages'),
