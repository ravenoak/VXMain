# -*- coding: utf-8 -*-
"""
Global configuration file for TG2-specific settings in vxweb.
...
from vxweb.lib import app_globals, helpers

base_config = AppConfig()
base_config.renderers = []
base_config.prefer_toscawidgets2 = True

base_config.package = vxweb
...
base_config.DBSession = vxweb.model.DBSession
# Configure the authentication backend

# YOU MUST CHANGE THIS VALUE IN PRODUCTION TO SECURE YOUR APP 
base_config.sa_auth.cookie_secret = "0a19c344-f5bc-4589-8ed1-bc61f77188b9"
